...
/*
  ...
  -Footer
    ...
    * 
    * 
?<Tilte />   //* THIS IS SELF CLOSING TAG AND COMMONLY USED TO CALL A COMPONET 
        
 ?       <Tilte></Tilte>    //* THIS IS 3RD WAY TO CALL A COMPONENT
 */
...
//const ele = (<h1 style={{ backgroundColor: "pink", color: "yellow" }}>foodie</h1>);
...
/*
 todo  jsx can only have 1 parent ,
    todo--  if you write like  " const ele = <h1>first</h1><h1>second</h1>"  here 2 parents cannot be written inside jsx , if you go and render it , it will show you error , 
    todo--   so to avoid it  ......use either div or Render.fragment componet which is exported from the React.....
    todo--   for-example : " const ele = <div> <h1>first</h1> <h1>second</h1> </div>"  or 
    todo--   " const ele = <React.Fragment> <h1>first</h1> <h1>second</h1> </React.Fragment>" or
    todo--   " const ele = <> <h1>first</h1> <h1>second</h1> </>"
    * also React.Fragment is like the empty tag , you cannot put anything inside it , it just just used whn u wanna put the more than 2 parents inside jsx
*/
...
//   name: "Domino's Pizza",
//   image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSSSCrvwgGOrjRtfRNRuWdzMGNuioaDB-8N7A&s ",
//   cusines: ["Pizzas", "Pastas", "Desserts", "Italians"],
//   rating: "4.2"
...
const restaurantList = [
  {
    ...
    analytics: {
      context: "seo-data-6a56d0f3-31da-411e-b801-829b3fa27fd0",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2025-01-07 09:00:00",
        opened: true,
      },
      badges: {
        textExtendedBadges: [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2025-01-06 22:59:00",
        opened: true,
      },
      badges: {
        imageBadges: [
...
//TODO  PASS THE PROPS MEANS PROPERTIES ,  HERE I AM PASSING FROM PARENT TO CHILD COMPONENT
//todo     ------------------- no key (always use keys if no unique key then use index) <<<<<< index(if no unique key , then index it should be last opt.) <<<<<< unique key (best) -----------------------------
const Body = () => {
    return (
